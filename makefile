...
O=bgi.o cabase.o com.o IpsNeutral.o mfSBA.o RWFile.o\
	IpsNeutralAux.o IpsNeutralStats.o linpack.o MainIPS.o randlib.o
...
IpsNeutral.o: IpsNeutral.cpp makefile IpsNeutral.h
